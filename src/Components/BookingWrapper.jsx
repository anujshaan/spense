...
const BookingWrapper = () => {
  ...
  return (
    <div className="absolute top-2/4 left-2/4 translate-x-[-50%] translate-y-[-50%] flex w-full justify-center">
      <div
        className={`inputButton relative rounded-tl-lg rounded-bl-lg ${isCheckIn ? 'w-96' : ''} transition ease-linear delay-150`}
        onClick={() => {
          setIsCheckIn(true);
          setIsCheckOut(false);
          setIsMembers(false)
      ...
      >
        ...
        {isCheckIn && (
          <div className="absolute bg-white p-4 rounded-xl w-96 top-12 left-[-10px]">
            <Calendar
      ...
      <div
        className={`inputButton relative border ${isCheckOut ? 'w-96' : ''}`}
        onClick={() => {
          setIsCheckOut(true);
          setIsCheckIn(false);
          setIsMembers(false)
      ...
      <div
        className="inputButton relative rounded-tr-lg rounded-br-lg"
        onClick={() => {setIsMembers(true); setIsCheckIn(false); setIsCheckOut(false)}}
      >
        {roomsCount ? (
        ...
        {isMembers && (
          <div className="absolute top-10 left-[-12px] bg-white p-5 w-full">
